...
import { ArrowRight, Truck, Shield, Clock, Globe, Package, CreditCard } from 'lucide-react'
    ...
    <section className="relative min-h-screen flex items-center overflow-hidden animated-gradient">
      ...
      <div className="absolute inset-0">
        ...
        >
          ...
          {/* Labels */}
          <text x="180" y="660" textAnchor="middle" fill="rgba(255,255,255,0.25)" fontSize="12" fontWeight="600">Shenzhen</text>
          <text x="1260" y="380" textAnchor="middle" fill="rgba(255,255,255,0.25)" fontSize="12" fontWeight="600">Gaborone</text>
        </svg>
      </div>
            ...
            <div className="space-y-4">
              ...
              >
                <div className="flex items-center gap-3 mb-3">
                  ...
                  <p className="text-sm font-semibold text-white/80">Cost Breakdown</p>
                </div>
