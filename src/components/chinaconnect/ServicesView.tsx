...
const services = [
  {
    ...
    description: 'Paste any link from Alibaba, 1688, Taobao or AliExpress — we verify the supplier and negotiate the best price.',
  ...
  },
  {
    ...
    description: 'Funds held in escrow until your shipment is confirmed — protecting both you and the supplier.',
  ...
  },
  {
    ...
    description: 'Air freight for speed or sea freight for bulk — delivered from China to Botswana with full tracking.',
  ...
  },
  {
    ...
    description: 'We handle all documentation, duties and regulations — no customs headaches.',
  ...
  },
  {
    icon: Package,
    title: 'Warehousing',
    description: 'Consolidate multiple orders in our China warehouses to cut shipping costs and arrive together.',
  ...
  },
  {
    ...
    description: 'Instant cost estimates, shipping timelines and tracking — 24/7.',
